...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ParliamentIntroduction'
        db.create_table(u'bills_parliamentintroduction', (
        ...
        db.send_create_signal(u'bills', ['ParliamentIntroduction'])


    def backwards(self, orm):
        # Deleting model 'ParliamentIntroduction'
        db.delete_table(u'bills_parliamentintroduction')
