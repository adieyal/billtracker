...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Bill.code'
        db.alter_column(u'bills_bill', 'code', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'Bill.code'
        db.alter_column(u'bills_bill', 'code', self.gf('django.db.models.fields.CharField')(max_length=10))
