...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BillsBeforeParliamentScraper.committee'
        db.add_column(u'scrapers_billsbeforeparliamentscraper', 'committee',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BillsBeforeParliamentScraper.committee'
        db.delete_column(u'scrapers_billsbeforeparliamentscraper', 'committee')
    ...
    models = {
        u'scrapers.billsbeforeparliamentscraper': {
            ...
            'committee': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
